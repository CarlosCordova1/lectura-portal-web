...
Tagify.prototype = {
    build : function( input ){
        ...
        this.DOM.scope.innerHTML = '<div class="form-control" ><input  list="tagifySuggestions'+ this.id +'" class="placeholder"/><span>'+ input.placeholder +'</span></div>';
    ...
    addTag : function( value ){
        ...
        return value.split(',').filter(function(v){ return !!v }).map(function(v){
            ...
            tagElm.innerHTML = "<x></x><div class='label-success'><span title='"+ v +"'>"+ v +" </span></div>";
