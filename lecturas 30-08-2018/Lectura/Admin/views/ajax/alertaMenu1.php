...
if($data1){
  ...
  <div class="panel-heading"><label>alerta</label>
   ...
   <table cellpadding="0" cellspacing="0" border="0" class="table table-striped table-bordered table-hover" id="example1">
     <thead>
           ...
           <tr class="odd gradeX">
                ...
                <td class="center" style="text-align: center;"><span class="label label-info">Ruta Alerta 5</span></td>
                <td class="center" style="text-align: center;">
                  <span class="label label-success">897 Alerta </span>
                </td>
                <td class="center" style="text-align: center;">fecha Alerta</td>
